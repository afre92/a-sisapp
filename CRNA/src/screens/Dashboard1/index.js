            ...
            <Grid>
              ...
              <TouchableWithoutFeedback onPress={() =>  this.props.navigation.navigate('Login')}>
                <Card style={{ height: 90, borderRadius: 30}}>
                  <View style={{justifyContent: 'center'}} >
                    <Text style={styles.cardTittle}> <Ionicons  size={25} name="md-stopwatch" color="grey" /> My Journey</Text>
                  </View>
                  <CardItem style={{backgroundColor: 'transparent',textAlign: 'center', justifyContent: 'center'}}>
                      <Text style={{color: 'black'}}>
                        Some text here asdfasdf 
                      </Text>
                  </CardItem>
              ...
              <Row>
                <TouchableWithoutFeedback onPress={() =>  this.props.navigation.navigate('Login')}>
                  <Card style={{ height: 90, borderRadius: 30}}>
                    <View style={{justifyContent: 'center'}} >
                      <Text style={styles.cardTittle}> <Ionicons  size={25} name="ios-thumbs-up" color="grey" /> My Journey</Text>
                    </View>
                    <CardItem style={{backgroundColor: 'transparent',textAlign: 'center', justifyContent: 'center'}}>
                        <Text style={{color: 'black'}}>
                          Some text here asdfasdf 
                ...
                <Row>
                  <TouchableWithoutFeedback onPress={() =>  this.props.navigation.navigate('Login')}>
                    <Card style={{ height: 90, borderRadius: 30}}>
                      <View style={{justifyContent: 'center'}} >
                        <Text style={styles.cardTittle}> <Ionicons  size={25} name="ios-stats" color="grey" /> My Journey</Text>
                      </View>
                      <CardItem style={{backgroundColor: 'transparent',textAlign: 'center', justifyContent: 'center'}}>
                        <Text style={{color: 'black'}}>
                          Some text here asdfasdf
